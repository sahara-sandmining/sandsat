...
# def time_series_images():
#     pass 

img_array = []
# curent_directory        = 
# all_files                 = os.listdir('/Users/srikara.cherukuri/Documents/tools/CoastSat/data/NARRA/S2/10m/')
# img_array = []
for filename in glob.glob('/Users/srikara.cherukuri/Documents/tools/CoastSat/data/detection_500m_4500beach/*.tif'):
